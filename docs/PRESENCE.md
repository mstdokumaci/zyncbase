...
Complete guide to STX's real-time presence system for user awareness and collaboration.
...
STX's presence system tracks ephemeral user state in real-time:
...
- [Examples](https://github.com/stx/examples) - Complete working examples
