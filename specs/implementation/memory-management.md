...
**Drivers**: [Threading Model Architecture](../../architecture/threading-model.md), [ADR-004: Zig as Core Language](../architecture/adrs.md#adr-004-zig-as-core-system-language)
