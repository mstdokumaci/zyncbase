...
const wire_error_map = std.StaticStringMap(WireError).initComptime(.{
    ...
    .{ "BinDataLengthTooLong", wireError("MESSAGE_TOO_LARGE", "Binary payload exceeds maximum length") },
    .{ "StringTooLong", wireError("MESSAGE_TOO_LARGE", "String payload exceeds maximum length") },
    .{ "ExtDataTooLarge", wireError("MESSAGE_TOO_LARGE", "Payload too big") },
