...
function deriveCategory(code: string): { category: string; retryable: boolean } {
  switch (code) {
...
export class ZyncBaseError extends Error {
  ...
  static fromServerResponse(payload: { code: string; message: string; retryAfter?: number; requestId?: number; path?: string[]; details?: Record<string, string[]> }): ZyncBaseError {
